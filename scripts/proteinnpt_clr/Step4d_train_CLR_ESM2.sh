...
export model_config_location=./model_configs/CLR_ESM2_650M.json
...
export target_config_location=target_configs/kinase_single_log10-km.json

export model_name_suffix='adk_single_km_CLR_ESM2' # Give a name to the model
