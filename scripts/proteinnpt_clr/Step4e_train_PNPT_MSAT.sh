...
export model_config_location=./model_configs/PNPT_MSAT.json
export embeddings_folder_MSAT=$embeddings_folder/MSA_Transformer
...
export target_config_location=target_configs/kinase_multi_log10-kcat_log10-km_temp_lid.json

export model_name_suffix='adk_multi4_PNPT_MSAT' # Give a name to the model
...
python train.py \
    ...
    --embedding_model_location ${MSA_Transformer_location} \
    ...
    --training_fp16 \
    --sequence_embeddings_folder ${embeddings_folder_MSAT} \
