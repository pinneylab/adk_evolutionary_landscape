...
export model_config_location=./model_configs/PNPT_Tranception.json
...
export target_config_location=target_configs/kinase_single_log10-kcat.json #kinase_multi_log10-kcat_log10-km_temp_lid.json

export model_name_suffix='adk_multi4_PNPT_Tranception' # Give a name to the model
